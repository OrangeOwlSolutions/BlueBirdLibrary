...
#ifndef __SUBTRACTION_CUH__
#define __SUBTRACTION_CUH__
...
namespace BB
{
	...
	//Scalar_Scalar(T1,T2,Sub,operator-) 	
	Matrix_Scalar_Matrix(T1,T2,Sub,operator-)
	Matrix_Scalar_CudaMatrix(T1,T2,Sub,operator-)
	Scalar_Matrix_Matrix(T1,T2,Sub,operator-)
	Scalar_Matrix_CudaMatrix(T1,T2,Sub,operator-)
	Expression_Scalar(Q,T1,T2,Sub,operator-)
	Scalar_Expression(Q,T1,T2,Sub,operator-)
	Matrix_Matrix_Matrix(T1,T2,Sub,operator-)
	Matrix_Matrix_CudaMatrix(T1,T2,Sub,operator-)
	Expression_Expression(Q1,T1,Q2,T2,Sub,operator-)
	Expression_Matrix_Matrix(Q,T1,T2,Sub,operator-)
	Expression_Matrix_CudaMatrix(Q,T1,T2,Sub,operator-)
	Matrix_Expression_Matrix(Q,T1,T2,Sub,operator-)
	Matrix_Expression_CudaMatrix(Q,T1,T2,Sub,operator-)
